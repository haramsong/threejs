...
import typeface from 'three/examples/fonts/Hakgyoansim Gaeulsopung B_Regular.json'
...
async function init() {
  ...
  const font = await fontLoader.loadAsync('./assets/fonts/Hakgyoansim Gaeulsopung B_Regular.json');
